...
<head>
    ...
    <title>IDS - Modifier Certificat Utilisateur || Tableau de Bord</title>
      <!-- Favicon -->
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="fa fa-edit"></i>&nbsp;Modifier le certificat #{{  $modifcertificat->id }}</h4>
                                <div class="basic-form">
                                    <form action="{{ action('AdminController@updateformcertificat',$modifcertificat->id) }}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                         @method('PATCH')
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Libéllé du certificat</label>
                                                <input type="text" name="libellecertificat" value="{{ $modifcertificat->libellecertificat }}" class="form-control @error('libellecertificat') is-invalid @enderror" placeholder="Entrer le Libéllé...">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control @error('id_user') is-invalid @enderror" name="id_user" readonly>
                                                    <option>{{ $modifcertificat->id_user }}</option>
                                                </select>
                                                @error('id_user')
                                                 <span class="invalid-feedback" role="alert">
                                                     <strong>{{ $message }}</strong>
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control" name="statut">
                                                    <option>{{ $modifcertificat->statut }}</option>
                                           ...
                                           <div class="form-group col-md-6">
                                                ...
                                                @enderror
                                                <br />
                                                <a href="{{ asset('uploads/certificat/'. $modifcertificat->files) }}" class="btn btn-info">Voir le Fichier  <i class="fa fa-hand-o-right"></i>&nbsp;{{ $modifcertificat->files }}</a>
                                            </div>
                                        </div>
