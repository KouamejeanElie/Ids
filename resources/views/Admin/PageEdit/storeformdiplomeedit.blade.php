...
<head>
    ...
    <title>IDS - Modifier Diplome Utilisateur || Tableau de Bord</title>
      <!-- Favicon -->
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="fa fa-plus"></i>&nbsp;Modifier le diplome #{{ $modifdiplome->id }}</h4>
                                <div class="basic-form">
                                    <form action="{{ action('AdminController@updateformdiplome',$modifdiplome->id) }}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                         @method('PATCH')
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Libéllé du diplome</label>
                                                <input type="text" name="libellediplome" value="{{ $modifdiplome->libellediplome }}" class="form-control @error('libellediplome') is-invalid @enderror" placeholder="Entrer le Libéllé...">
                                            ...
                                            <div class="form-group col-md-6">
                                                ...
                                                <select class="form-control" name="id_user" readonly>
                                                 <option>{{ $modifdiplome->id_user }}</option>
                                                </select>
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Statut</label>
                                                <select class="form-control" name="statut">
                                                    <option>{{ $modifdiplome->statut }}</option>
                                           ...
                                           <div class="form-group col-md-6">
                                                ...
                                                @enderror
                                                <br />
                                                 <a href="{{ asset('uploads/diplome/'. $modifdiplome->files) }}" class="btn btn-info">Voir le Fichier  <i class="fa fa-hand-o-right"></i>&nbsp;{{ $modifdiplome->files }}</a>
                                            </div>
                                        </div>
                                        <button type="submit" class="btn btn-info">Valider&nbsp;<i class="fa fa-plus"></i></button>
                                    </form>
                                </div>
                            </div>
                        </div>                       
