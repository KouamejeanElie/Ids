...
<head>
    ...
    <title>IDS - Modification du projet || Tableau de Bord</title>
      <!-- Favicon -->
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="fa fa-edit"></i>&nbsp;Modification du projet #{{ $ajoutprojet->id }}</h4>
                                <div class="basic-form">
                                    <form action="{{ action('AdminController@updateformprojet',$ajoutprojet->id) }}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                         @method('PATCH')
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Titre du projet</label>
                                                <input type="text" value="{{ $ajoutprojet->titreprojet }}" name="titreprojet" class="form-control @error('titreprojet') is-invalid @enderror" placeholder="Entrer le titre du projet">
                                                @error('titreprojet')
                                             ...
                                             <div class="form-group col-md-6">
                                                ...
                                                <textarea name="descriptifprojet" class="form-control">
                                                    {{ $ajoutprojet->descriptifprojet }}
                                                </textarea>
                                            </div>
                                           <div class="form-group col-md-6">
                                        ...
                                        <img src="{{ asset('uploads/projet/'. $ajoutprojet->image)}}"><br /><br />
