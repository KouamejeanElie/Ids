...
<head>
    ...
    <title>IDS - Modification du temoignage || Tableau de Bord</title>
      <!-- Favicon -->
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="fa fa-edit"></i>&nbsp;Modification du temoignage #{{ $ajouttemoignage->id }}</h4>
                                <div class="basic-form">
                                    <form action="{{ action('AdminController@updateformtemoignage',$ajouttemoignage->id) }}" method="POST" enctype="multipart/form-data">
                                        {{ csrf_field() }}
                                         @method('PATCH')
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                <label>Nom</label>
                                                <input type="text" value="{{ $ajouttemoignage->nom }}" name="nom" class="form-control @error('nom') is-invalid @enderror" placeholder="Entrer le nom...">
                                                @error('nom')
                                             ...
                                             <div class="form-group col-md-6">
                                                ...
                                                <input type="text" value="{{ $ajouttemoignage->provenance }}" name="provenance" class="form-control @error('provenance') is-invalid @enderror" placeholder="Entrer la provenance...">
                                                @error('provenance')
                                                 <span class="invalid-feedback" role="alert">
                                                     <strong>{{ $message }}</strong>
                                                 </span>
                                        ...
                                        <img src="{{ asset('uploads/temoignage/'. $ajouttemoignage->image)}}"><br /><br />
