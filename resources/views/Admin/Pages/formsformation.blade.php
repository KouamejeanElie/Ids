                            ...
                            <div class="card-body">
                                ...
                                <div class="active-member">
                                    <div class="table-responsive">
                                             ...
                                             @foreach($listeTotalFormations as $listeTotalFormation)
                                                <tr>
                                                    ...
                                                    <td>{{ $listeTotalFormation->formations }}
                                                     ...
                                                     <td>
                                                        <form action="{{ route('path_delete_admin_formation',$listeTotalFormation->id) }}" onsubmit="return confirm('Etes vous sûre ?');" method="POST">
                                                            {{ csrf_field() }}
                                                            {{ method_field('DELETE')}}
                                        ...
                                        @else
                                          <p class="alert alert-danger alert-dismissible" style="text-align:center;"><i class="fa fa-info-circle" style="font-size: 24px;"></i>&nbsp;Oops!! Aucune Formation demandée !
