                                    ...
                                    <form action="{{ route('path_admin_store_certificat') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="libellecertificat" class="form-control @error('libellecertificat') is-invalid @enderror" placeholder="Entrer le Libéllé...">
                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-xs mb-0">
                                           ...
                                           <tr>
                                               ...
                                               <td><a href="{{ asset('uploads/certificat/'. $listeAllcertificat->files) }}">Télécharger <i class="fa fa-hand-o-right"></i>&nbsp;{{ $listeAllcertificat->files }}</a></td>
                                                   <td>
                                                  ...
                                                  <form method="post" action="{{ route('path_delete_admin_store_certificat', $listeAllcertificat->id) }}" onsubmit="return confirm('Etes-vous sûre!');">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE')}}
