...
<head>
    ...
    <title>IDS - Ajout de Projet || Tableau de Bord</title>
      <!-- Favicon -->
            ...
            <div class="container-fluid mt-3">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title"><i class="fa fa-plus"></i>&nbsp;Ajouter un Projet à votre plateforme</h4>
                                    ...
                                    <form action="{{ route('path_admin_store_projet') }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-6">
                                                ...
                                                <input type="text" name="titreprojet" class="form-control @error('titreprojet') is-invalid @enderror" placeholder="Entrer le titre du projet">
                                                @error('titreprojet')
                                        ...
                                        <div class="form-group">
                                            <label>Descriptif du projet</label>
                                             <textarea class="form-control" name="descriptifprojet">
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                 <p class="alert alert-warning">Liste des projets Ajoutés</p>
                                <div class="active-member">
                                    <div class="table-responsive">
                                        <table class="table table-xs mb-0">
                                            ...
                                            <tbody>
                                             @foreach($listeTotalAjoutProjets as $listeTotalAjoutProjet)
                                                <tr>
                                                    <td>{{ $listeTotalAjoutProjet->titreprojet }}</td>
                                                    <td><textarea class="form-control" readonly>{{ $listeTotalAjoutProjet->descriptifprojet }}
                                                    </textarea></td>
                                                    <td>
                                                    <img src="{{ asset('uploads/projet/'. $listeTotalAjoutProjet->image) }}">
                                                    </td>
                                                     <td>
                                                    <a href="{{ route('path_edit_admin_storeprojet', $listeTotalAjoutProjet->id )}}">
                                                  <button class="btn btn-block btn-outline-info btn-sm"><i class="fa fa-edit"></i></button>
                                                  </a><br />
                                                  <form method="post" action="{{ route('path_delete_admin_store_projet', $listeTotalAjoutProjet->id) }}" onsubmit="return confirm('Etes-vous sûre!');">
                                                    {{ csrf_field() }}
                                                    {{ method_field('DELETE')}}
