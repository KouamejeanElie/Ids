                        ...
                        <div class="single-service-top">
                            ...
                            <div class="text">
                                ...
                                <div class="inner">
                                    ...
                                    <p>Notre objectif est que le projet atteigne sa finalité qui n'est autre que la création de la valeur, et ce, en faisant passer l'organisation d'un état actuel à un état futur désiré.&nbsp; <a href="{{ route('path_etudeconseil') }}">Lire suite</a></p>
                                </div>
                            </div>
                        </div>
