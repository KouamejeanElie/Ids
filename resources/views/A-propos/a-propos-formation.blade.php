                        ...
                        <div class="single-service-top">
                            ...
                            <div class="text">
                                ...
                                <div class="inner">
                                    ...
                                    <p>Notre objectif est de vous offrir une formation de qualité en vous donnant les rudiments néccessaire à l'avancement de votre activité.&nbsp; <a href="{{ route('path_formation') }}">Lire suite</a></p>
                                </div>
                            </div>
                        </div>
