                    ...
                    <div class="col-xl-8 col-lg-7 col-md-12 col-sm-12">
                        <div class="single-service-top">
                            ...
                            <div class="text">
                                ...
                                <div class="inner">
                                    <p>Les blockchains permettent de stocker et d'échanger de la valeur sur internet sans intermédiaire centralisé. Elles sont le moteur technologique des cryptomonnaies&nbsp; <a href="{{ route('path_blockchain') }}">Lire suite</a></p>
                                </div>
                            </div>
                        </div>
